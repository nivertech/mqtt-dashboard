...
class MyMQTTClientCore(MQTTClientCore):
    def __init__(self, appname, clienttype):
        ...
        Label(frame, text="Rec").grid(row=load_ofx+1, column=2)
        Label(frame, text="Sent").grid(row=load_ofx+1, column=1)
        Label(frame, text="Rec").grid(row=load_ofx+1, column=4)
        Label(frame, text="Sent").grid(row=load_ofx+1, column=3)
        Label(frame, text="Rec").grid(row=load_ofx+1, column=6)
        Label(frame, text="Sent").grid(row=load_ofx+1, column=5)
        Label(frame, text="Rec").grid(row=load_ofx+1, column=8)
        Label(frame, text="Sent").grid(row=load_ofx+1, column=7)
        Label(frame, text="Rec").grid(row=load_ofx+1, column=10)
        ...
        self.bytes_ts_text = Text(frame, height=1, width=10, state=DISABLED)
        self.bytes_ts_text.grid(row=4, column=9)
        self.bytes_tr_text = Text(frame, height=1, width=10, state=DISABLED)
        ...
        self.messages_ts_text = Text(frame, height=1, width=10, state=DISABLED)
        self.messages_ts_text.grid(row=5, column=9)
        self.messages_tr_text = Text(frame, height=1, width=10, state=DISABLED)
...
#        self.connections_s_text.grid(row=6+1, column=1, columnspan=2)
        self.connections_1m_text = Text(frame, height=1, width=20, state=DISABLED)
        self.connections_1m_text.grid(row=6+1, column=3, columnspan=2)
        self.connections_5m_text = Text(frame, height=1, width=20, state=DISABLED)
        self.connections_5m_text.grid(row=6+1, column=5, columnspan=2)
        self.connections_15m_text = Text(frame, height=1, width=20, state=DISABLED)
...
#        self.sockets_s_text.grid(row=7+1, column=1, columnspan=2)
        self.sockets_1m_text = Text(frame, height=1, width=20, state=DISABLED)
        self.sockets_1m_text.grid(row=7+1, column=3, columnspan=2)
        self.sockets_5m_text = Text(frame, height=1, width=20, state=DISABLED)
        self.sockets_5m_text.grid(row=7+1, column=5, columnspan=2)
        self.sockets_15m_text = Text(frame, height=1, width=20, state=DISABLED)
...
#        self.sockets_t_text.grid(row=7+1, column=9, columnspan=2)
        ...
        self.active_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.inactive_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.clients_total_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.expired_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.max_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.uptime_text = Text(frame, height=1, width=8, state=DISABLED)
        self.uptime_text.grid(row=other_ofx+1, column=other_ofy+2)
        Label(frame, text="Heap").grid(row=other_ofx+2, column=other_ofy+1, sticky=W)
        self.heap_text = Text(frame, height=1, width=8, state=DISABLED)
        ...
        self.heap_max_text = Text(frame, height=1, width=8, state=DISABLED)
...
#        self.connections_text.grid(row=other_ofx+5, column=other_ofy+2, rowspan=3)
        ...
        self.retained_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.stored_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.dropped_text = Text(frame, height=1, width=5, state=DISABLED)
        ...
        self.inflight_text = Text(frame, height=1, width=5, state=DISABLED)
        self.inflight_text.grid(row=msg_ofx+4, column=msg_ofy+2)
        Label(frame, text="Subscriptions").grid(row=msg_ofx+5, column=msg_ofy+1, sticky=W)
        self.subscriptions_text = Text(frame, height=1, width=5, state=DISABLED)
...
#                    self.mqttcore.sockets_t_text.insert(END, msg.payload)
                    ...
                    self.mqttcore.uptime_text.insert(END, msg.payload)
                ...
                elif((msg.topic == "$SYS/broker/log/N") or 
